...
/*
Insert the following data into the specie table:
Pokemon
Digimon
*/
...
/*
Modify your inserted animal so it includes the specie_id value:
If the name ends in "mon" it will be Digimon
All other animal are Pokemon
*/
...
/*
Modify your inserted animal to include owner information (owner_id):
...
((SELECT id from vets where name = 'William Tatcher'),(SELECT id from specie where name = 'Pokemon')),
((SELECT id from vets where name = 'Stephanie Mendez'),(SELECT id from specie where name = 'Digimon')),
((SELECT id from vets where name = 'Stephanie Mendez'),(SELECT id from specie where name = 'Pokemon')),
((SELECT id from vets where name = 'Jack Harkness'),(SELECT id from specie where name = 'Digimon')));
